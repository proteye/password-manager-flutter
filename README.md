...
Cross-platform password manager app on Flutter.
...
1. To add a new localizable string, open the `app_en.arb` file at `lib/common/localization/app_en.arb`.
...
1. For each supported locale, add a new ARB file in `lib/common/localization`.
