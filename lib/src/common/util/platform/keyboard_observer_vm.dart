...
import 'package:password_manager/src/common/util/platform/keyboard_observer_interface.dart';

IKeyboardObserver $getKeyboardObserver() => _KeyboardObserver$VM();

@sealed
class _KeyboardObserver$VM
