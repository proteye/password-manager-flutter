...
import 'package:password_manager/src/common/database/platform/database_vm.dart'
    // ignore: uri_does_not_exist
    if (dart.library.html) 'package:password_manager/src/common/database/platform/database_js.dart';
import 'package:password_manager/src/common/database/queries.dart';
    ...
    batch(
      (b) => b
        ...
        ..insertAllOnConflictUpdate(
          kvTbl,
          toInsert.map((e) => e.$3).toList(growable: false),
        ),
    ).ignore();
  }
