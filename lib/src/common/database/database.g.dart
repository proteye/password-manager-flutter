...
class SettingsTbl extends Table with TableInfo<SettingsTbl, SettingsTblData> {
  ...
  List<GeneratedColumn> get $columns =>
      [userId, jsonData, memo, version, metaCreatedAt, metaUpdatedAt];
  @override
...
class $CredentialTblFilterComposer extends Composer<_$Database, CredentialTbl> {
...
class $CredentialTblOrderingComposer
    extends Composer<_$Database, CredentialTbl> {
...
class $CredentialTblTableManager extends RootTableManager<
    ...
    (
      CredentialTblData,
      BaseReferences<_$Database, CredentialTbl, CredentialTblData>
    ),
    CredentialTblData,
    PrefetchHooks Function()> {
  $CredentialTblTableManager(_$Database db, CredentialTbl table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
