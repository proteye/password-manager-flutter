...
abstract final class Config {
  ...
  /// Default user id (e.g. unauthorized guest).
  static const defaultUserId = 'guest';
  ...
  /// [Dio] will throw the [DioException] with [DioExceptionType.connectTimeout]
  /// type when time out.
  /// e.g. 15000
  ...
  /// [Dio] will throw the [DioException] with [DioExceptionType.receiveTimeout]
  /// type when time out.
  /// e.g. 10000
  ...
  /// e.g. true
  static const bool dropDatabase = bool.fromEnvironment('DROP_DATABASE');

  /// Whether to use in-memory database.
  static const bool inMemoryDatabase =
      bool.fromEnvironment('IN_MEMORY_DATABASE');
  ...
  /// Minimum screen width for app window size configuration.
  /// 1470 is macbook air 13.6" width.
  static const int minScreenWidth =
      int.fromEnvironment('MIN_SCREEN_WIDTH', defaultValue: 1470);
